...
<div class="w-100 h-100 d-flex justify-content-center align-items-center text-white">
    <div class="w-25 p-5 border rounded" style="background-color: #254E70">
        <form method="POST" action="{{route('login')}}">
            @csrf
        <div class="w-100 mb-2 text-center fs-2">Login:</div>
        ...
        <!-- Submit button -->
        <button type="submit" data-mdb-button-init data-mdb-ripple-init class="w-100 rounded btn-primary btn-block mb-2 py-2">Sign in</button>

        <!-- Register buttons -->
        <div class="text-center">
            <p>Not a member? <a href="http://127.0.0.1:8000/register">Register</a></p>
        </div>
        </form>
    </div>
</div>